...
start-e2e:
	ARGOCD_CLUSTER_CONFIG_NAMESPACES="argocd-e2e-cluster-config, argocd-test-impersonation-1-046, argocd-agent-principal-1-051, argocd-agent-agent-1-052, ns-hosting-principal, ns-hosting-managed-agent, ns-hosting-autonomous-agent" make run
