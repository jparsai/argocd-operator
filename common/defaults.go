...
const (
	...
	// ArgoCDApplicationControllerComponentView is the name of ClusterRole to configure view permissions for the application controller control plane component
	ArgoCDApplicationControllerComponentView = "argocd-application-controller-view"

	// ArgoCDApplicationControllerComponentAdmin is the name of ClusterRole to configure admin permissions for the application controller control plane component
